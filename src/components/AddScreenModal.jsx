      ...
      <div className="container">
        ...
        <form onSubmit={handleAddSong}>
          <div className="FormFields">
            ...
            <br />
            <br />
            <label className="uploadBtn" htmlFor="uploadFile">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="14"
                height="14"
            ...
            <div className="previewFile">
              <span>
                {/* <img src={""} className=previewFileImg} /> */}
                {/* <span className=previewFileName}>{fileName}</span> */}
                <img
                  src={previewImg}
                  alt="preview File"
                  className="previewFileImg"
                />
                <span className="previewFileName">
